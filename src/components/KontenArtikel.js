...
const KontenArtikel = ({
  ...
  return (
    <section className="flex-col gap-2 items-center justify-center w-full md:my-16 my-8 lg:px-32 lg:pb-20 px-8">
      ...
      <div className="flex flex-col items-center">
        <div className="flex items-center justify-center w-full mb-10">
          <Image
            ...
            width={500}
            height={300}
            className="md:w-[700px] md:h-[400px] w-full object-cover"
          />
        </div>
        <div className=" w-full lg:pt-0 pt-3">
          ...
          <br />
          <a href={sumber} className="text-sm md:text-base hover:text-blue-500">
            Sumber: {sumber}
          </a>
        </div>
      </div>
